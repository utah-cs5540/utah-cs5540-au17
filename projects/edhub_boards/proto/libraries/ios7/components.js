...
prx.types.ios7_navbar_buttons = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-navbar" '+((prx.componentsHelper.getProp(item.overlay,'boolean'))? 'data-mpoverlay="1"': '')+'>';
...
prx.types.ios7_toolbar = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-toolbar" '+((prx.componentsHelper.getProp(item.overlay,'boolean'))? 'data-mpoverlay="1"': '')+'>';
...
prx.types.ios7_statusbar = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-statusbar" '+((prx.componentsHelper.getProp(item.overlay,'boolean'))? 'data-mpoverlay="1"': '')+'>';
...
prx.types.ios7_button_bg = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-button">';
...
prx.types.ios7_segmentedcontrol = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-segmentedcontrol">';
...
prx.types.ios7_pagecontroller = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-pagecontroller">';
...
prx.types.ios7_label = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-label">';
...
prx.types.ios7_textfield = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-textfield type-ios7-textfield-'+prx.componentsHelper.getProp(item.inputtype,'text-other')+'">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid);
...
prx.types.ios7_textarea = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-textarea">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid);
...
prx.types.ios7_checkbox = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-checkbox">';
...
prx.types.ios7_switch = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-switch">';
...
prx.types.ios7_slider = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-slider">';
...
prx.types.ios7_picker = {
		...
		,onDisplay: function(item,containerid,pageid,symbol) {
			...
			var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-picker"><div class="outer">';
...
prx.types.ios8_searchbar = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios8-searchbar type-ios8-searchbar-text">';
...
prx.types.ios7_listcomplex = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-list">';
...
prx.types.ios7_list_header = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-list-header">';
...
prx.types.ios7_alert = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-alert">';
...
prx.types.ios7_actionsheet = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-actionsheet">';
...
prx.types.ios7_control_popover = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-control-popover">';
...
prx.types.ios7_popover = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-popover">';
...
prx.types.ios7_progressbar = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-progressbar">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid);
...
prx.types.ios7_badge = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios7-badge">';
...
prx.types.ios8_map_tag = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios8-map-tag">';
...
prx.types.ios8_message_bubble = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + ' class="' + prx.items.getComponentBaseClasses(item, containerid) + ' box pos type-ios8-message-bubble">'
...
prx.types.ios10_widget = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="'+_id+'" class="box pos type-ios10-widget '+((item.name=='ios10_notification') ? 'type-ios10-notification' : '')+' ' + prx.items.getComponentBaseClasses(item, containerid) + '" ' + prx.items.getComponentBaseAttributes(item, containerid) + '>';
